            ...
            <section class="vip_prerogative">
                <router-link to="/vipcard/vipDescription" class="header_style">
                    ...
                    <section class="header_right">
                        <span>会员说明</span>
                        <svg fill="#ccc" viewBox="0 0 1024 1024" id="arrow-right" class="icon"><path d="M716.298 417.341l-.01.01L307.702 7.23l-94.295 94.649 408.591 410.117-408.591 410.137 94.295 94.639 502.891-504.76z" class="selected"></path></svg>
                    </section>
                </router-link>
                <section class="vip_detail">
                    <div class="vip_detail_left">
                        <img src="@/assets/images/sheng.jpeg" height="80" width="70" alt="">
                    </div>
                ...
                <section class="vip_detail">
                    <div class="vip_detail_left">
                        <img src="@/assets/images/jifen.jpeg" height="80" width="70" alt="">
                    </div>
                    <div class="vip_detail_right">
                        <h4>减免配送费</h4>
                        <p>每月减免30单，每日可减免3单，每单最高减4元</p>
