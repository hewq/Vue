        ...
        <section class="adddetail">
            <form action="" @submit.prevent>
                <section class="ui-padding-block">
                    ...
                    <div class="input-new">
                        <input type="text" placeholder="请填写您的手机号" :class="{verifies:verifyfour}" v-model="telenum" @input="inputThingfour">
...
<script>
    ...
    import {postAddAddress} from '@/assets/scripts/getData'
