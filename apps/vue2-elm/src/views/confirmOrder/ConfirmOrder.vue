        ...
        <section v-if="!showLoading">
                ...
                <div class="address_empty_left">
                    ...
                    <div class="address_detail_container" v-else>
                        <header>
                            ...
                            <span>{{choosedAddrwss.sex == 1 ? '先生' : '女士'}}</span>
            ...
            <section class="delivery_model container_style">
                ...
                <section class="deliver_time">
                    ...
                    <p v-if="checkoutData.cart.is_delivery_by_fengniao">蜂鸟专送</p>
                </section>
            </section>
            ...
            <section class="pay_way container_style">
                <router-link :to="{path: '/confirmOrder/remark', query: {id: checkoutData.cart.id, sig: checkoutData.sig}}" class="header_style">
                    <span>订单备注</span>
                    <div class="more_type">
                        <span class="ellipsis">{{remartText || inputText ? remarklist: '口味、偏好等'}}</span>
                        <svg class="address_empty_right">
                            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#arrow-right"></use>
                        </svg>
                    </div>
...
<script>
    ...
    import {checkout, getAddress, placeOrders, getAddressList} from '@/assets/scripts/getData'
